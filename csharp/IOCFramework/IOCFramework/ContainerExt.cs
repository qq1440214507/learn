...
public static class ContainerExtensions
{
    ...
    public static Container Register<TService>(this Container container, Func<Container, TService> factory,
    ...
    public static Container Register(this Container container, Assembly assembly)
    {
        ...
        {
            container.Register(typedAttribute.Attribute.ServiceType, typedAttribute.ServiceType,
    ...
    private static object? Create(Container container, Type type, Type[] genericArguments)
    {
        ...
        if (constructors.Length == 0)
        {
            throw new InvalidOperationException(
                $"Cannot create the instance of {type} which does not have a public constructor.");
        }
